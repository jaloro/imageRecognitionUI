	...
	var app = new Vue({		// 使用 Vue 引擎
		...
		methods:{
			...
			parseRes:function( a_resData = null ){		// 解析返回值
				...
				{
					a_resData["objects"][ i ]["relative_coordinates"]["b_x"] = a_resData["objects"][ i ]["relative_coordinates"]["center_x"] * this.picCrtWidth - ( a_resData["objects"][ i ]["relative_coordinates"]["width"] * this.picCrtWidth * 0.5 );
					a_resData["objects"][ i ]["relative_coordinates"]["b_y"] = a_resData["objects"][ i ]["relative_coordinates"]["center_y"] * this.picCrtHeight - ( a_resData["objects"][ i ]["relative_coordinates"]["height"] * this.picCrtHeight * 0.5 );
